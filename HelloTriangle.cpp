	...
	for( size_t i = 0; i < commandBuffers.size(); ++i ){
		beginCommandBuffer( commandBuffers[i] );
			...
			recordImageBarrier(
				commandBuffers[i],
				swapchainImages[i],
				VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, /*0*/VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
	...
	for( size_t i = 0; i < computeCommandBuffers.size(); ++i ){
		...
		beginCommandBuffer( computeCommandBuffers[i] );
			...
			recordImageBarrier(
				...
				swapchainImages[i],
				/*0*/VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
			...
			recordImageBarrier(
				computeCommandBuffers[i],
				swapchainImages[i],
				VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, /*0*/VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
